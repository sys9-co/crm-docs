...
│  └──────────────────┘  └──────────────────┘  └──────────────────┘                                  │
│                                                                                                     │
│  ┌─ 💰 สัดส่วนงบประมาณโครงการ ────────────────────────────────────────────────────────────────┐  │
│  │                                                                                                │  │
│  │  ┌─────────────────────┐  ┌─────────────────────┐  ┌─────────────────────┐                    │  │
│  │  │ งบประมาณโครงการ     │  │ งบประมาณ BOQ        │  │ แผนขาย (Sale Plan) │                    │  │
│  │  │     ฿21.0M         │  │     ฿14.2M         │  │     ฿10.6M         │                    │  │
│  │  │  ██████████████████  │  │  ████████████       │  │  ████████           │                    │  │
│  │  │  100% (ฐานอ้างอิง)   │  │  67.6% ของโครงการ   │  │  50.2% ของโครงการ   │                    │  │
│  │  └─────────────────────┘  └─────────────────────┘  └─────────────────────┘                    │  │
│  │                                                                                                │  │
│  │  แยกรายทีม:                                                                                  │  │
│  │  🔵 ปลีก(สนญ)      ████████████████████ ฿5.0M BOQ ██████████ SP ████████ SP/BOQ ██████       │  │
│  │  🟢 ปลีก(สันกำแพง)  ██████████████     ฿3.5M 64%     40%       62.5%                         │  │
│  │  🟣 โครงการ         ████████████████████ ฿8.0M 80%     70%       87.5%                         │  │
│  │  🟠 ส่งร้านค้า       ██████████         ฿4.5M 55.6%   30%       54%                           │  │
│  └──────────────────────────────────────────────────────────────────────────────────────────────┘  │
│                                                                                                     │
